        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-orange-500">FoodOrder</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md leading-relaxed">
              Delicious food delivered to your doorstep. Order from your favorite restaurants and enjoy a great dining experience at home.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/orders" className="text-gray-300 hover:text-orange-500 transition-colors">
                  My Orders
                </Link>
              </li>
              <li>
                <Link to="/cart" className="text-gray-300 hover:text-orange-500 transition-colors">
                  Cart
                </Link>
              </li>
              <li>
